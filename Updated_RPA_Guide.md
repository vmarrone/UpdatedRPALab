...
### 4. Reviewing the badging application
...
1. Click **All** (1), then type **RPA Hub** in the filter navigator (2) then click on **RPA Hub Workspace
...
2. In the top left-hand corner, click on the 'hamburger' icon to access the available lists
...
3. Click on **Bot Process** (1), then go to **Assign Configuration** (Click the little arrow next to **Create Configuration**)."
...
4. Check the box (1) to select the **Badge printing - Bot process configuration** record then click **submit** (2)
...
5. This tab should open in the workspace, showing the bot process record, update the **Name** field (1) to rename the Bot Process. remove config then click **Save** (2) 
...
6. Now that we have this new Badge Pringing bot process record created, lets populate some fields that are important., Click on the **Business Applications** Tab
...
7. Click **Add** to  map the existing Business Application (from CMDB) to the Bot Process
...
8. Select the **Badge Printing** (1)  Business application then click **Add** (2)
...
## 7. Getting Started with RPA Design Studio
